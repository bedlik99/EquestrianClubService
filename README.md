...
```
<h3>I have deployed application on Heroku. Due to finishing engineering studies I have halted the development of the app, and took it away from Heroku platform. 
<hr>
